...
contract Seller is Ownable {
    ...
    modifier isAuthorised() {
        require(isSeller(msg.sender), "seller address is not authorised");
        _;
    }
    ...
    function addSeller(address _address) public onlyOwner {
        require(!areSellers[_address], "seller is already recorded");
    ...
    function deleteSeller(address _address) public onlyOwner {
        require(areSellers[_address], "seller does not exist");
